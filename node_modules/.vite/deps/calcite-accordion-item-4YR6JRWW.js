...
var AccordionItem = proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    } }, h("div", { "aria-controls": regionId, class: { "accordion-item-header": true, [CSS_UTILITY.rtl]: dir === "rtl" }, id: buttonId, onClick: this.itemHeaderClickHandler, role: "button" }, this.icon ? iconEl : null, h("div", { class: "accordion-item-header-text" }, h("span", { class: "accordion-item-title" }, this.itemTitle), this.itemSubtitle ? h("span", { class: "accordion-item-subtitle" }, this.itemSubtitle) : null), h("calcite-icon", { class: "accordion-item-expand-icon", icon: this.iconType === "chevron" ? "chevronDown" : this.iconType === "caret" ? "caretDown" : this.active ? "minus" : "plus", scale: "s" })), h("div", { "aria-expanded": toAriaBoolean(this.active), "aria-labelledby": buttonId, class: "accordion-item-content", id: regionId, role: "region" }, h("slot", null))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
...
@esri/calcite-components/dist/components/calcite-accordion-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-accordion-item-4YR6JRWW.js.map
