...
var h = 0;
var u = a("featurelayer-simplify-thresholds") ?? [0.5, 0.5, 0.5, 0.5];
var l = u[0];
var c2 = u[1];
var m = u[2];
var g = u[3];
var _ = a("featurelayer-simplify-payload-size-factors") ?? [1, 2, 4];
var y = _[0];
var p = _[1];
var f = _[2];
var I = a("featurelayer-simplify-mobile-factor") ?? 2;
var x = a("esri-mobile");
var A = class {
  constructor(e2, t4) {
  ...
  getAreaSimplificationThreshold(e2, t4) {
    let r2 = 1;
    const s = x ? I : 1;
    t4 > 4e6 ? r2 = f * s : t4 > 1e6 ? r2 = p * s : t4 > 5e5 ? r2 = y * s : t4 > 1e5 && (r2 = s);
    let i = 0;
    e2 > 4e3 ? i = g * r2 : e2 > 2e3 ? i = m * r2 : e2 > 100 ? i = c2 : e2 > 15 && (i = l);
    let o = 8;
  ...
  geometry() {
    const e2 = this.readHydratedGeometry(), t4 = ne(e2, this.geometryType, this.hasZ, this.hasM), r2 = d(t4);
  ...
  removeIds(e2) {
    if (t(this._objectIdToIndex)) {
      ...
      for (; t5.next(); )
        e3.set(t5.getObjectId(), t5.getIndex());
  ...
  *features() {
  ...
  _computeCentroid() {
    ...
    if (!e2 || e2.hasIndeterminateRingOrder)
      return null;
    const t4 = c(this.getQuantizationTransform(), null);
...
//# sourceMappingURL=chunk-ZUKXZSOF.js.map
