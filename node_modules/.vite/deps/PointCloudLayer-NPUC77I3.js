...
e([d({ type: String, json: { write: { enabled: true, isRequired: true } } })], t2.prototype, "field", void 0), e([d({ readOnly: true, nonNullable: true, json: { read: false } })], t2.prototype, "type", void 0), t2 = e([n("esri.layers.pointCloudFilters.PointCloudFilter")], t2);
var l3 = t2;

// node_modules/@arcgis/core/layers/pointCloudFilters/PointCloudBitfieldFilter.js
var d5;
var p3 = d5 = class extends l3 {
  constructor(e3) {
    super(e3), this.requiredClearBits = null, this.requiredSetBits = null, this.type = "bitfield";
  }
  clone() {
    return new d5({ field: this.field, requiredClearBits: m(this.requiredClearBits), requiredSetBits: m(this.requiredSetBits) });
  }
};
e([d({ type: [S], json: { write: { enabled: true, overridePolicy() {
  return { enabled: true, isRequired: !this.requiredSetBits };
} } } })], p3.prototype, "requiredClearBits", void 0), e([d({ type: [S], json: { write: { enabled: true, overridePolicy() {
  return { enabled: true, isRequired: !this.requiredClearBits };
} } } })], p3.prototype, "requiredSetBits", void 0), e([r3({ pointCloudBitfieldFilter: "bitfield" })], p3.prototype, "type", void 0), p3 = d5 = e([n("esri.layers.pointCloudFilters.PointCloudBitfieldFilter")], p3);
var u = p3;

// node_modules/@arcgis/core/layers/pointCloudFilters/PointCloudReturnFilter.js
var n2;
var p4 = n2 = class extends l3 {
  constructor(r4) {
    super(r4), this.includedReturns = [], this.type = "return";
  }
  clone() {
    return new n2({ field: this.field, includedReturns: m(this.includedReturns) });
  }
};
e([d({ type: [["firstOfMany", "last", "lastOfMany", "single"]], json: { write: { enabled: true, isRequired: true } } })], p4.prototype, "includedReturns", void 0), e([r3({ pointCloudReturnFilter: "return" })], p4.prototype, "type", void 0), p4 = n2 = e([n("esri.layers.pointCloudFilters.PointCloudReturnFilter")], p4);
var u2 = p4;
...
var l4 = p5 = class extends l3 {
  ...
  clone() {
    return new p5({ field: this.field, mode: this.mode, values: m(this.values) });
  }
};
e([d({ type: ["exclude", "include"], json: { write: { enabled: true, isRequired: true } } })], l4.prototype, "mode", void 0), e([r3({ pointCloudValueFilter: "value" })], l4.prototype, "type", void 0), e([d({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], l4.prototype, "values", void 0), l4 = p5 = e([n("esri.layers.pointCloudFilters.PointCloudValueFilter")], l4);
var u3 = l4;
...
var c3 = i3 = class extends a {
  ...
  clone() {
    return new i3({ ...this.cloneProperties(), field: m(this.field) });
  }
};
e([r3({ pointCloudRGBRenderer: "point-cloud-rgb" })], c3.prototype, "type", void 0), e([d({ type: String, json: { write: true } })], c3.prototype, "field", void 0), c3 = i3 = e([n("esri.renderers.PointCloudRGBRenderer")], c3);
var n3 = c3;

// node_modules/@arcgis/core/renderers/support/pointCloud/typeUtils.js
var i4 = { key: "type", base: a, typeMap: { "point-cloud-class-breaks": d4, "point-cloud-rgb": n3, "point-cloud-stretch": a2, "point-cloud-unique-value": a3 }, errorContext: "renderer" };

// node_modules/@arcgis/core/layers/PointCloudLayer.js
var A2 = s.getLogger("esri.layers.PointCloudLayer");
var N = l2();
var R = class extends A(p2(c2(v(t(O(i(b))))))) {
  constructor(...e3) {
  ...
  readServiceFields(e3, r4, t3) {
    return Array.isArray(e3) ? e3.map((e4) => {
      const r5 = new y();
      return "FieldTypeInteger" === e4.type && ((e4 = m(e4)).type = "esriFieldTypeInteger"), r5.read(e4, t3), r5;
    }) : Array.isArray(r4.attributeStorageInfo) ? r4.attributeStorageInfo.map((e4) => new y({ name: e4.name, type: "ELEVATION" === e4.name ? "double" : "integer" })) : null;
  }
  ...
  createPopupTemplate(e3) {
    const r4 = d3(this, e3);
    return this._formatPopupTemplateReturnsField(r4), this._formatPopupTemplateRGBField(r4), r4;
  }
  _formatPopupTemplateReturnsField(e3) {
    const r4 = this.fieldsIndex.get("RETURNS");
    if (!r4)
      return;
    const t3 = e3.fieldInfos.find((e4) => e4.fieldName === r4.name);
    if (!t3)
      return;
    const o3 = new i2({ name: "pcl-returns-decoded", title: r4.alias || r4.name, expression: `
  ...
  _formatPopupTemplateRGBField(e3) {
    ...
    if (!t3)
      return;
    const o3 = new i2({ name: "pcl-rgb-decoded", title: r4.alias || r4.name, expression: `
  ...
  async saveAs(e3, r4) {
    return this._debouncedSaveOperations(K.SAVE_AS, { ...r4, getTypeKeywords: () => this._getTypeKeywords(), portalItemLayerType: "point-cloud" }, e3);
  }
  async save() {
