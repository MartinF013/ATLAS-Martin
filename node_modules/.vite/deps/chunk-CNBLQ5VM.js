...
async function c(e, t2 = {}, a) {
  await e.load(a);
  const o = G(e.itemUrl, "resources"), { start: n = 1, num: c2 = 10, sortOrder: u2 = "asc", sortField: i2 = "created" } = t2, l2 = { query: { start: n, num: c2, sortOrder: u2, sortField: i2, token: e.apiKey }, signal: m(a, "signal") }, p2 = await e.portal._request(o, l2);
...
async function u(e, o, n, c2) {
  ...
  await u2.load(c2);
  const i2 = G(u2.userItemUrl, "add" === o ? "addResources" : "updateResources"), [l2, d2] = p(e.path), m3 = await h(n), f2 = new FormData();
  return l2 && "." !== l2 && f2.append("resourcesPrefix", l2), f2.append("fileName", d2), f2.append("file", m3, d2), f2.append("f", "json"), r(c2) && c2.access && f2.append("access", c2.access), await u2.portal._request(i2, { method: "post", body: f2, signal: m(c2, "signal") }), e;
}
async function i(e, a, o) {
  ...
  await e.portal._request(n, { method: "post", query: { resource: a.path }, signal: m(o, "signal") }), a.portalItem = null;
}
async function l(e, t2) {
  await e.load(t2);
  const a = G(e.userItemUrl, "removeResources");
  return e.portal._request(a, { method: "post", query: { deleteAll: true }, signal: m(t2, "signal") });
}
function p(e) {
...
//# sourceMappingURL=chunk-CNBLQ5VM.js.map
