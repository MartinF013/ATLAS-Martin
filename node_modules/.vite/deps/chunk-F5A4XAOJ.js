...
var h = class {
  constructor(t = 10485760) {
    this._maxSize = t, this._db = /* @__PURE__ */ new Map(), this._size = 0, this._hit = 0, this._miss = 0, this._removeFuncs = new n(), this._users = new n();
  }
  destroy() {
...
//# sourceMappingURL=chunk-F5A4XAOJ.js.map
