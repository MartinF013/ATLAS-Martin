...
var o = import("./labelFormatUtils-C5TN762Y.js");
var c = class {
  constructor(e2, s3) {
  ...
  async updateSchema(r4, a3) {
    ...
    this._computedFields = await Promise.all(n2), this._canCacheExpressionValue = !this._computedFields.some((e2) => "expression" === e2.type && e2.expression.referencesScale()), this._statisticFields = d;
  }
...
var l = class extends c {
  ...
  search(t2) {
    ...
    if (r(s3))
      return s3.readers;
    const r4 = /* @__PURE__ */ new Map(), n2 = this._searchIndex(t2.bounds), i3 = [];
    for (const a3 of n2) {
...
//# sourceMappingURL=chunk-4JEAJE3K.js.map
