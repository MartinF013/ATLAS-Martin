...
var h = class extends t(y) {
  constructor(r2) {
    super(r2), this.processor = null, this.slicePlaneEnabled = false, this.layer = new n2();
  }
  initialize() {
    this._set("processor", new _({ owner: this })), this.processor.setup();
  }
  destroy() {
    this._set("processor", l(this.processor));
  }
  get graphics() {
  ...
  getHit(r2) {
    return this.processor.getHit(r2);
  }
  whenGraphicBounds(r2, s) {
    return this.processor.whenGraphicBounds(r2, s);
  }
  graphicChanged(r2) {
  ...
  async fetchPopupFeatures(r2, s) {
    return r(s) ? s.clientGraphics : null;
  }
  highlight(r2) {
    return this.processor.highlight(r2);
  }
  maskOccludee(r2) {
    return this.processor.maskOccludee(r2);
  }
};
e([d({ readOnly: true })], h.prototype, "graphics", null), e([d()], h.prototype, "loadedGraphics", null), e([d({ readOnly: true })], h.prototype, "updating", null), e([d({ constructOnly: true })], h.prototype, "view", void 0), e([d()], h.prototype, "processor", void 0), e([d({ type: Boolean })], h.prototype, "slicePlaneEnabled", void 0), e([d()], h.prototype, "layer", void 0), h = e([n("esri.views.3d.layers.GraphicsView3D")], h);
...
//# sourceMappingURL=GraphicsView3D-7JEGUAR5.js.map
