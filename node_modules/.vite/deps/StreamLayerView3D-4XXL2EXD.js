...
import "./chunk-IHCVEO7N.js";
import "./chunk-L6YDAPZR.js";
import "./chunk-5SHHATAH.js";
import "./chunk-3ITGQWSQ.js";
import "./chunk-FXA5BH2C.js";
import "./chunk-U7UHMH7X.js";
import "./chunk-CBFCCRGT.js";
import {
  n as n2
...
import "./chunk-TUZ3FLXS.js";
import "./chunk-TMLBWFXL.js";
...
e([d({ type: Number, json: { read: true } })], u2.prototype, "objectId", void 0), u2 = e([n("esri.layers.graphics.controllers.StreamGraphic")], u2);
var y3 = class {
  constructor(e2) {
  ...
  removeById(e2) {
    const t2 = this._idToGraphic.get(e2);
    return t2 ? (t2.sourceLayer = t2.layer = null, this._idToGraphic.delete(e2), t2) : null;
  }
  update(e2, t2) {
    this.onUpdate(e2, t2);
  }
...
var f = class extends a(m(y)) {
  constructor() {
    super(...arguments), this._updateInfo = { websocket: 0, client: 0 }, this.graphics = new r2();
  }
  initialize() {
  ...
  _clearInterval() {
    this._updateIntervalId && (clearInterval(this._updateIntervalId), this._updateIntervalId = 0);
  }
  clear() {
    this._clearInterval(), this.connection && (this.connection.destroy(), this.connection = null), this.store && (this.store.destroy(), this.store = null), this.graphics.clear(), this.handles.removeAll();
  }
  get updating() {
    return !this.connection || "connected" === this.connection.connectionStatus;
  }
  _startup() {
    const { layer: e2, layerView: t2 } = this, { parsedUrl: r3, spatialReference: o2, definitionExpression: s3, geometryDefinition: i2, objectIdField: n3, timeInfo: c, purgeOptions: l2, maxReconnectionAttempts: m3, maxReconnectionInterval: u4, customParameters: f2 } = e2, _ = i.toJSON(e2.geometryType), g2 = o2, I = t2.view.spatialReference, v = { geometry: i2, where: s3 };
    this.clear(), this._set("connection", t(r3, g2, I, _, v, m3, u4, f2)), this._outSpatialReference = I.toJSON(), this.store = new y3(this._onUpdate.bind(this)), this.featuresManager = new h(this.store, n3, c.toJSON(), l2);
    const j = "startup-watches";
    this.handles.remove(j), this.handles.add([this.connection.on("feature", (e3) => this._onFeature(e3)), l(() => [e2.definitionExpression, e2.geometryDefinition, e2.purgeOptions], () => this._startup())], j), this._initUpdateInterval();
  }
  _onFeature(e2) {
    ...
    try {
      r(e2.geometry) && !e2.geometry.spatialReference && (e2.geometry.spatialReference = this._outSpatialReference);
      const t2 = u2.fromJSON(e2);
      t2.sourceLayer = t2.layer = this.layer, this.featuresManager.add(t2);
    } catch {
    }
  }
  _onUpdate(e2, t2) {
    r(t2) && this.graphics.removeMany(t2), r(e2) && (this._updateInfo.client += e2.length, this.graphics.addMany(e2));
  }
  _initUpdateInterval() {
    this._clearInterval();
    ...
    this._updateIntervalId = setInterval(() => {
      const e3 = performance.now(), r3 = e3 - t2;
      if (r3 > m2) {
        t2 = e3;
        const o2 = Math.round(this._updateInfo.client / (r3 / 1e3)), s3 = Math.round(this._updateInfo.websocket / (r3 / 1e3));
        this._updateInfo.client = 0, this._updateInfo.websocket = 0, this.layerView.emit("update-rate", { client: o2, websocket: s3 });
      }
...
e([d()], f.prototype, "connection", void 0), e([d()], f.prototype, "layer", void 0), e([d()], f.prototype, "layerView", void 0), e([d({ readOnly: true })], f.prototype, "updating", null), f = e([n("esri.layers.graphics.controllers.StreamController")], f);

// node_modules/@arcgis/core/views/layers/StreamLayerView.js
var s2 = (s3) => {
  let c = class extends s3 {
    constructor(...r3) {
      super(...r3), this.connectionError = null, this.connectionStatus = "disconnected", this.filter = null;
    }
  };
  return e([d({ readOnly: true })], c.prototype, "connectionError", void 0), e([d({ aliasOf: "controller.connection.connectionStatus", readOnly: true })], c.prototype, "connectionStatus", void 0), e([d({ type: y2 })], c.prototype, "filter", void 0), c = e([n("esri.layers.mixins.StreamLayerView")], c), c;
};

// node_modules/@arcgis/core/views/3d/layers/StreamLayerView3D.js
var y4 = class extends s2(E(n2(u))) {
  constructor() {
    super(...arguments), this.type = "stream-3d", this.updatePolicy = o.ASYNC, this.hasZ = true, this.hasM = false;
  }
  initialize() {
    this.handles.add(l(() => this.suspended, (r3) => {
      this.controller && (r3 ? this.controller.pauseStream() : this.controller.resumeStream());
    }));
  }
  get connectionError() {
    const r3 = this.get("controller.connection.errorString");
    if (r3)
      return new s("stream-controller", r3);
  }
  createQuery() {
    return new b({ outFields: ["*"], returnGeometry: true, outSpatialReference: this.view.spatialReference });
  }
  queryLatestObservations(r3, e2) {
    return this.queryEngine.executeQueryForLatestObservations(this._ensureQuery(r3), e2 == null ? void 0 : e2.signal);
  }
  createController() {
...
e([d({ readOnly: true })], y4.prototype, "updatePolicy", void 0), e([d({ readOnly: true })], y4.prototype, "connectionError", null), e([d()], y4.prototype, "controller", void 0), e([d({ readOnly: true })], y4.prototype, "hasZ", void 0), e([d({ readOnly: true })], y4.prototype, "hasM", void 0), y4 = e([n("esri.views.3d.layers.StreamLayerView3D")], y4);
var u3 = y4;
export {
  u3 as default
};
//# sourceMappingURL=StreamLayerView3D-4XXL2EXD.js.map
