...
var ListItemGroup = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return h(Host, null, heading ? h(Heading, { class: CSS.heading, level }, heading) : null, h("div", { class: CSS.container, role: "group" }, h("slot", null)));
  }
  get el() {
    return this;
  }
  static get style() {
    return listItemGroupCss;
  }
...
@esri/calcite-components/dist/components/calcite-list-item-group.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-item-group-2TAQ56UX.js.map
