...
function l(t, n, r = 1e3) {
  switch (t.toLowerCase()) {
    ...
    case "mean":
      return s(K(n));
    case "min":
      return Math.min.apply(Math, K(n));
    case "sum":
      return u(K(n));
    case "max":
      return Math.max.apply(Math, K(n));
    case "stdev":
    case "stddev":
      return Math.sqrt(c(K(n)));
    case "var":
    case "variance":
      return c(K(n));
    case "count":
...
//# sourceMappingURL=chunk-Q3ZGS5K7.js.map
