...
var O2 = class extends n2(u) {
  constructor() {
    super(...arguments), this.type = "route-3d", this.loadedGraphics = new r2(), this._byObjectID = /* @__PURE__ */ new Map(), this.slicePlaneEnabled = false, this.fullExtentInLocalViewSpatialReference = null;
  }
  initialize() {
    this._set("processor", new _({ owner: this, scaleVisibilityEnabled: true, frustumVisibilityEnabled: true })), this.addResolvingPromise(this.processor.setup()), this.updatingHandles.addOnCollectionChange(() => this._routeItems, (e2) => this._routeItemsChanged(e2), h), this.addResolvingPromise(l3(this).then((e2) => this.fullExtentInLocalViewSpatialReference = e2)), this.handles.add(f(() => {
      var _a, _b;
  ...
  get _routeItems() {
    return new p({ getCollections: () => [this.layer.pointBarriers, this.layer.polygonBarriers, this.layer.polylineBarriers, this.layer.stops, this.layer.directionLines, this.layer.directionPoints, r(this.layer.routeInfo) ? new j([this.layer.routeInfo]) : null] });
  }
  _routeItemsChanged(e2) {
    ...
    if (e2.added.length) {
      ...
      for (const t of e2.added)
        this.handles.add([l2(() => t.geometry, (e3, r3) => {
          this._updateGraphic(t, "geometry", e3, r3);
        }), l2(() => t.symbol, (e3, r3) => {
          this._updateGraphic(t, "symbol", e3, r3);
        })], t);
    }
  }
  get legendEnabled() {
  ...
  async fetchPopupFeatures(e2, t) {
    return r(t) ? t.clientGraphics : null;
  }
  getHit(e2) {
  ...
  async queryGraphics() {
    return new j(this.loadedGraphics.toArray());
  }
  maskOccludee(e2) {
  ...
  highlight(e2) {
    if (S(e2)) {
      const t = this._byObjectID.get(e2);
      return this.processor.highlight(t);
    }
    return this.processor.highlight(e2);
  }
  get updatePolicy() {
    var _a;
    return ((_a = this.processor) == null ? void 0 : _a.graphicsCore.effectiveUpdatePolicy) || o.SYNC;
  }
  canResume() {
    var _a;
  ...
  _updateGraphic(e2, t, r3, s) {
    var _a;
    const o2 = this._byObjectID.get(e2);
    o2[t] = r3, V.graphic = o2, V.property = t, V.oldValue = s, V.newValue = r3, (_a = this.processor) == null ? void 0 : _a.graphicsCore.graphicUpdateHandler(V);
  }
};
e([d()], O2.prototype, "_routeItems", null), e([d()], O2.prototype, "loadedGraphics", void 0), e([d({ readOnly: true })], O2.prototype, "legendEnabled", null), e([d()], O2.prototype, "layer", void 0), e([d({ readOnly: true })], O2.prototype, "processor", void 0), e([d({ type: Boolean })], O2.prototype, "slicePlaneEnabled", void 0), O2 = e([n("esri.views.3d.layers.RouteLayerView3D")], O2);
var V = { graphic: null, property: null, oldValue: null, newValue: null };
var _2 = O2;
export {
  _2 as default
};
//# sourceMappingURL=RouteLayerView3D-3TNHN2ZE.js.map
