...
var i = s.getLogger("esri.intl");
function s3(t2, r3, n = {}) {
  const { format: o2 = {} } = n;
  return r2(t2, (t3) => u2(t3, r3, o2));
}
function u2(t2, e, n) {
  let o2, i3;
  const s6 = t2.indexOf(":");
...
async function o(e, n, o2, i3) {
  ...
  const c4 = a5[1] ? `${a5[1]}/` : "", l3 = a5[2], w = u(i3), h2 = `${c4}${l3}.json`, u4 = w ? `${c4}${l3}_${w}.json` : h2;
  let f2;
  try {
    f2 = await s4(e(u4));
  } catch (d) {
...
//# sourceMappingURL=chunk-WBX2MY5R.js.map
