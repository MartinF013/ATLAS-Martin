...
function l(n) {
  ...
  return s2 > 0 ? (r2.x /= s2, r2.y /= s2, true === n.hasZ && (r2.z /= s2), true === n.hasM && (r2.m /= s2), new j(r2)) : o2 > 0 ? (e2.x /= o2, e2.y /= o2, true === n.hasZ && (r2.z /= o2), true === n.hasM && (e2.m /= o2), new j(e2)) : null;
}
function u(n) {
  ...
  return c2.spatialReference = n.spatialReference.toJSON(), true === n.hasZ && (c2.z = o2 / n.points.length), true === n.hasM && (c2.m = s2 / n.points.length), new j(c2);
}
function y(t, n) {
...
//# sourceMappingURL=chunk-RO2QI6Y3.js.map
