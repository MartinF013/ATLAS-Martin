...
var i = class {
  ...
  _normalize(n, i2, t2, o3 = 0, r2 = false) {
    return (t2 -= o3) < n ? t2 += this.ndiff(n - t2) : t2 > i2 && (t2 -= this.ndiff(t2 - i2)), r2 && t2 === i2 && (t2 = n), t2 + o3;
  }
  normalize(n, i2 = 0, t2 = false) {
    return this._normalize(this.min, this.max, n, i2, t2);
  }
  clamp(i2, t2 = 0) {
    return o(i2 - t2, this.min, this.max) + t2;
  }
  monotonic(n, i2, t2) {
  ...
  shortestSignedDiff(n, i2) {
    n = this.normalize(n);
    const t2 = (i2 = this.normalize(i2)) - n, o3 = i2 < n ? this.minimalMonotonic(n, i2) - n : i2 - this.minimalMonotonic(i2, n);
    return Math.abs(t2) < Math.abs(o3) ? t2 : o3;
  }
  contains(n, i2, t2) {
...
//# sourceMappingURL=chunk-FUQI3AAI.js.map
