...
var Checkbox = proxyCustomElement(class extends H {
  ...
  // --------------------------------------------------------------------------
  render() {
    return h(Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h("div", { "aria-checked": toAriaBoolean(this.checked), "aria-label": getLabelText(this), class: "toggle", onBlur: this.onToggleBlur, onFocus: this.onToggleFocus, ref: (toggleEl) => this.toggleEl = toggleEl, role: "checkbox", tabIndex: this.disabled ? void 0 : 0 }, h("svg", { class: "check-svg", viewBox: "0 0 16 16" }, h("path", { d: this.getPath() })), h("slot", null)), h(HiddenFormInputSlot, { component: this }));
  }
  get el() {
    return this;
  }
...
@esri/calcite-components/dist/components/calcite-checkbox.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-checkbox-S64L55KX.js.map
