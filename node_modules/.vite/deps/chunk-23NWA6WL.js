...
var r2 = s.getLogger("esri.core.Accessor");
function t2(e) {
...
var T = { native: (e) => ({ type: "native", value: e }), array: (e) => ({ type: "array", value: e }), oneOf: (e) => ({ type: "one-of", values: e }) };
function _(e) {
  if (!e || !("type" in e))
    return false;
  switch (e.type) {
...
//# sourceMappingURL=chunk-23NWA6WL.js.map
