...
var c = { r: true, g: true, b: true, a: true };
function _(t) {
  return T2.intern(t);
}
function d(t) {
...
var S2 = class {
  constructor(t, e) {
    this.makeKey = t, this.makeRef = e, this.interns = /* @__PURE__ */ new Map();
  }
  intern(t) {
    if (!t)
      return null;
    const e = this.makeKey(t), i = this.interns;
...
var N2 = new S2(x, (t) => ({ blending: _(t.blending), culling: d(t.culling), polygonOffset: p(t.polygonOffset), depthTest: u(t.depthTest), stencilTest: g(t.stencilTest), depthWrite: f(t.depthWrite), colorWrite: v(t.colorWrite), stencilWrite: I(t.stencilWrite) }));
function x(t) {
...
//# sourceMappingURL=chunk-B7F3T673.js.map
