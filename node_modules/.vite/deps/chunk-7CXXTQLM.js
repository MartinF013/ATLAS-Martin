...
function c(t3) {
  ...
  if (d3 = s3(t3, d3, h3), d3 = s3(t3, d3, w3), d3 = s3(t3, d3, g2), d3 = s3(t3, d3, p2), d3 !== t3.byteLength)
  ...
  for (let e2 = 0; e2 < h3.length; e2++) {
    ...
    for (let o3 = 0; o3 < w3[e2]; o3++) {
      t4 += g2[m3];
      const e3 = p2[m3];
      f3[3 * m3] = Math.min(u3.maxX, u3.minX + 2 * u3.errorX * t4), f3[3 * m3 + 1] = Math.min(u3.maxY, u3.minY + 2 * u3.errorY * U), f3[3 * m3 + 2] = Math.min(u3.maxZ, u3.minZ + 2 * u3.errorZ * e3), m3++;
    }
  }
...
function d(o3, r3, n3) {
  ...
  for (let e2 = 0; e2 < a3; e2++) {
    ...
    n3[e2] = h3 & p2, h3 >>>= s5, w3 -= s5, w3 + s5 > 32 && (h3 |= f3[g2 - 1] >> 8 - w3);
  }
  return r3 + g2;
}
...
function s4(e2, t3) {
  ...
  for (let o3 = 0; o3 < t3.length; o3++) {
    ...
    n3.fields[i2.property] = a3(e2, r3), r3 += m2[u3].BYTES_PER_ELEMENT;
  }
...
function f2(e2, t3) {
  return new (0, m2[t3.valueType])(e2, t3.byteOffset, t3.count * t3.valuesPerElement);
}
function l2(e2, t3) {
...
function b(n3, r3, o3) {
  ...
  for (let s5 = 0; s5 < r3.ordering.length; s5++) {
    const n4 = r3.ordering[s5], o4 = m(r3[n4]);
...
function y(e2) {
  return { isDraco: false, isLegacy: false, color: null != e2.color, normal: null != e2.normal, uv0: null != e2.uv0, uvRegion: null != e2.uvRegion, featureIndex: null != e2.faceRange && null != e2.featureId };
}
function g(e2, t3) {
...
function w2(e2, t3) {
  return !(!e2 || !e2.compressedAttributes || "draco" !== e2.compressedAttributes.encoding) ? v(e2.compressedAttributes.attributes) : e2 ? y(e2) : p(t3);
}
function p(e2) {
  const t3 = { isDraco: false, isLegacy: true, color: false, normal: false, uv0: false, uvRegion: false, featureIndex: false };
  for (const n3 of e2.ordering)
    if (e2.vertexAttributes[n3])
      switch (n3) {
        case "position":
          break;
        case "normal":
  ...
  return e2.featureAttributes && e2.featureAttributeOrder && (t3.featureIndex = true), t3;
}
function v(e2) {
  const t3 = { isDraco: true, isLegacy: false, color: false, normal: false, uv0: false, uvRegion: false, featureIndex: false };
  for (const n3 of e2)
    switch (n3) {
      case "position":
        break;
...
//# sourceMappingURL=chunk-7CXXTQLM.js.map
