...
var i = class {
  ...
  set(t2, e4, i2 = r.USER) {
    ...
    if (o || (o = /* @__PURE__ */ new Map(), this._originStores[i2] = o), o.set(t2, e4), !this._values.has(t2) || q(this._propertyOriginMap.get(t2)) <= i2) {
...
var a = (t2) => {
  let a2 = class extends t2 {
    constructor(...r2) {
      super(...r2);
      const t3 = q(e2(this)), i2 = t3.store, c = new i();
...
//# sourceMappingURL=chunk-BUWXVMJU.js.map
