...
function V(t3, r2, e2, n2, o2) {
  ...
  if ("V" === u && "V" === a2)
    return o2.dir = "RTL" === s2 ? Lt : Tt, M2(t3, o2);
  if ("L" === u && "VRTL" === e2)
    return "LTR" === s2 ? (o2.dir = Tt, t3 = y(t3, o2)) : (o2.dir = Lt, t3 = y(t3, o2)), M2(t3);
  if ("VLTR" === r2 && "LLTR" === e2)
    return o2.dir = Tt, y(t3, o2);
  if ("V" === u && "L" === a2 && s2 !== f2)
    return t3 = M2(t3), "RTL" === s2 ? V(t3, "LLTR", "VLTR", n2, o2) : V(t3, "LRTL", "VRTL", n2, o2);
  if ("VRTL" === r2 && "LRTL" === e2)
    return V(t3, "LRTL", "VRTL", n2, o2);
  if ("L" === u && "L" === a2) {
    const r3 = o2.swap;
    return o2.swap = r3.substr(0, 1) + "N", "RTL" === s2 ? (o2.dir = Lt, t3 = y(t3, o2), o2.swap = "N" + r3.substr(1, 2), o2.dir = Tt, t3 = y(t3, o2)) : (o2.dir = Tt, t3 = y(t3, o2), o2.swap = "N" + r3.substr(1, 2), t3 = V(t3, "VLTR", "LRTL", o2.swap, o2)), t3;
  }
  return t3;
}
function E2(t3, r2, e2) {
  ...
  return "C" === u.charAt(0) && (i2 = x2(t3), u = "ltr" === i2 || "rtl" === i2 ? i2.toUpperCase() : "L" === r2.inFormat.charAt(2) ? "LTR" : "RTL", r2.inFormat = n2 + u), "C" === s2.charAt(0) && (i2 = x2(t3), "rtl" === i2 ? s2 = "RTL" : "ltr" === i2 ? (i2 = O2(t3), s2 = i2.toUpperCase()) : s2 = "L" === r2.outFormat.charAt(2) ? "LTR" : "RTL", r2.outFormat = o2 + s2), r2;
}
function I(t3, r2, e2) {
  if (0 === r2.length)
    return "";
  void 0 === t3 && (t3 = true), void 0 === e2 && (e2 = true);
...
function j2(t3, r2, e2, n2, o2) {
  ...
  for (let a2 = r2; a2 * e2 < n2; a2 += e2)
    if (Z(t3[a2]) || tt(t3[a2])) {
      if ("ل" === t3[a2] && q2(t3, a2 + e2, e2, n2)) {
        t3[a2] = nt(t3[a2 + e2], 0 === i2 ? T : U), a2 += e2, et(t3, a2, e2, n2), o2 && (u[s2] = a2, s2++), i2 = 0;
        continue;
      }
      const r3 = t3[a2];
      1 === i2 ? t3[a2] = $(t3, a2 + e2, e2, n2) ? Q(t3[a2]) : X(t3[a2], E) : true === $(t3, a2 + e2, e2, n2) ? t3[a2] = X(t3[a2], R) : t3[a2] = X(t3[a2], L), tt(r3) || (i2 = 1), true === K(r3) && (i2 = 0);
    } else
      i2 = 0;
  return u;
}
  ...
  return { UBAT_L: () => (o2.lastArabic = false, n), UBAT_R: () => (o2.lastArabic = false, p), UBAT_ON: () => x, UBAT_AN: () => s, UBAT_EN: () => o2.lastArabic ? s : r, UBAT_AL: () => (o2.lastArabic = true, o2.hasUbatAl = true, p), UBAT_WS: () => x, UBAT_CS: () => {
    ...
    if ("VLTR" === o2.inFormat) {
      ...
      for (; o3 < e3 && r2[o3] === b; )
        o3++;
      if (o3 < e3) {
        const e4 = t3[n2].charCodeAt[0], i3 = e4 >= 1425 && e4 <= 2303 || 64286 === e4, u = r2[o3];
        if (i3 && (u === p || u === F))
          return p;
      }
    }
...
function rt(t3) {
  return "L" === t3 ? "LTR" : "R" === t3 ? "RTL" : "C" === t3 ? "CLR" : "D" === t3 ? "CRL" : "";
}
...
//# sourceMappingURL=chunk-RB2H3SKO.js.map
