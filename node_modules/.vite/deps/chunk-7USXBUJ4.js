...
async function n(n2) {
  ...
  if (i2.isWebMercator)
    return j(n2);
  const s2 = k.WGS84;
  return await fn(i2, s2), rn(n2, s2);
}
function i(e, t) {
  if (!s(e, t)) {
...
var f = { DEVELOPER_BASEMAP: "DeveloperBasemap", JSAPI: "ArcGIS API for JavaScript", METADATA: "Metadata", MULTI_LAYER: "Multilayer", SINGLE_LAYER: "Singlelayer", TABLE: "Table" };
...
//# sourceMappingURL=chunk-7USXBUJ4.js.map
