...
async function o(t2) {
  ...
  const a = await c(t2), i2 = await new Promise((e) => r2.toBlob(e, a));
  if (!i2)
...
async function c(e) {
  ...
  const t2 = e.src;
  if (X(t2)) {
    const { mediaType: e2 } = nt(t2);
    return "image/jpeg" === e2 ? e2 : "image/png";
  }
...
//# sourceMappingURL=chunk-VYKXSWPZ.js.map
