...
function M2(e2) {
  return n2(e2, { FeatureTypeList: { FeatureType: (e3) => {
    const t3 = { typeName: "undefined:undefined", name: "", title: "", description: "", extent: null, namespacePrefix: "", namespaceUri: "", supportedSpatialReferences: [] }, r2 = /* @__PURE__ */ new Set([4326]), n4 = (e4) => {
      var _a, _b;
      const t4 = parseInt((_b = (_a = e4.textContent.match(/(?<wkid>\d+$)/i)) == null ? void 0 : _a.groups) == null ? void 0 : _b.wkid, 10);
...
async function _(t3, r2, n4 = {}) {
  var _a;
  let a, o3 = false;
  const [s3, i3] = await Promise.all([K(t3.operations.GetFeature.url, r2, t3.operations.GetFeature.outputFormat, { ...n4, count: 1 }), U(t3.operations.GetFeature.url, { responseType: "text", query: Z(r2, void 0, { ...n4, count: 1 }), signal: n4 == null ? void 0 : n4.signal })]), p = "FeatureCollection" === s3.type && ((_a = s3.features[0]) == null ? void 0 : _a.geometry);
  if (p) {
    let e2;
...
function B(e2) {
  ...
  for (const s3 of o3) {
    ...
    if (s3.hasAttribute("type") ? i3 = re(s3.getAttribute("type")).name : o2(s3, { simpleType: { restriction: (e3) => (i3 = re(e3.getAttribute("base")).name, { maxLength: (e4) => {
      ...
      continue;
    const u = "true" === s3.getAttribute("nillable");
    let c2 = false;
...
async function K(r2, n4, a, o3) {
  var _a;
  let { data: s3 } = await U(r2, { responseType: "text", query: Z(n4, a, o3), signal: o3 == null ? void 0 : o3.signal });
  ...
  try {
    ...
    throw new s(A, "Error while parsing the response", { response: s3, error: i3 });
  }
}
function Z(e2, t3, r2) {
...
//# sourceMappingURL=chunk-3RU6IUIF.js.map
