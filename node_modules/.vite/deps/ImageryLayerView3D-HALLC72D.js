...
var n2 = class extends m(q) {
  constructor() {
    super(...arguments), this.type = "imagery-3d", this.redrawDebounced = x(async (e2) => {
      this.redraw((e3, t2) => this._redrawImage(e3, t2), e2);
    }, 2e3);
  }
  initialize() {
  ...
  _initializeMaximumDataResolution() {
    const e2 = this.view.basemapTerrain.spatialReference, t2 = this.layer.fullExtent;
    !t2 || e2.equals(t2.spatialReference), this.maximumDataResolution = { x: this.layer.pixelSizeX, y: this.layer.pixelSizeY };
  }
  getFetchOptions() {
    return { timeExtent: this.timeExtent };
  }
  async processResult(e2, t2, a) {
    t2.imageElement ? e2.image = t2.imageElement : (e2.image = document.createElement("canvas"), e2.pixelData = t2.pixelData, await this._redrawImage(e2, a));
  }
  async _redrawImage(e2, a) {
    if (!(e2.image instanceof HTMLCanvasElement) || t(e2.pixelData))
      throw new Error();
    const i = e2.image, r = i.getContext("2d"), s = await this.layer.applyRenderer(e2.pixelData, { signal: a }), o = this.layer.applyFilter(s).pixelBlock;
    if (t(o))
      throw new Error();
    i.width = o.width, i.height = o.height;
    const n3 = r.createImageData(o.width, o.height);
    n3.data.set(o.getAsRGBA()), r.putImageData(n3, 0, 0);
  }
};
n2 = e([n("esri.views.3d.layers.ImageryLayerView3D")], n2);
var m2 = n2;
export {
  m2 as default
};
//# sourceMappingURL=ImageryLayerView3D-HALLC72D.js.map
