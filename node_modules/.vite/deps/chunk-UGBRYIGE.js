...
var Action = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return h(Host, { onClick: this.calciteActionClickHandler }, h("button", { "aria-busy": toAriaBoolean(loading), "aria-disabled": toAriaBoolean(disabled), "aria-label": ariaLabel, class: buttonClasses, disabled, ref: (buttonEl) => this.buttonEl = buttonEl }, this.renderIconContainer(), this.renderTextContainer()));
  }
  get el() {
    return this;
  }
...
@esri/calcite-components/dist/components/action.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UGBRYIGE.js.map
