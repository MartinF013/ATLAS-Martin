...
var t3 = class {
  constructor(t4, e4, r3 = 0, s, i2) {
    ...
    this.typedBuffer = null == i2 ? new f(e4, u2) : new f(e4, u2, (i2 - r3) / f.BYTES_PER_ELEMENT), this.typedBufferStride = s / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride), this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT;
  }
  sliceBuffer(t4, e4, r3 = this.count - e4) {
...
var e3 = class {
  constructor(t4, e4, r3 = 0, f, s) {
    this.TypedArrayConstructor = t4, this.elementCount = 4;
    const i2 = this.TypedArrayConstructor;
...
//# sourceMappingURL=chunk-MQBVOUKB.js.map
