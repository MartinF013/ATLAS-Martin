...
var u2 = class extends n2(u) {
  constructor() {
    super(...arguments), this.type = "graphics-3d", this.slicePlaneEnabled = false, this.fullExtentInLocalViewSpatialReference = null;
  }
  initialize() {
  ...
  async fetchPopupFeatures(e2, s) {
    return r(s) ? s.clientGraphics : null;
  }
  getHit(e2) {
    return this.processor.getHit(e2);
  }
  whenGraphicBounds(e2, s) {
    return this.processor.whenGraphicBounds(e2, s);
  }
  computeAttachmentOrigin(e2, s) {
    var _a;
    return (_a = this.processor) == null ? void 0 : _a.computeAttachmentOrigin(e2, s);
  }
  getSymbolLayerSize(e2, s) {
    return this.processor.getSymbolLayerSize(e2, s);
  }
  queryGraphics() {
...
e([d()], u2.prototype, "loadedGraphics", null), e([d({ readOnly: true })], u2.prototype, "legendEnabled", null), e([d()], u2.prototype, "layer", void 0), e([d({ readOnly: true })], u2.prototype, "processor", void 0), e([d({ type: Boolean })], u2.prototype, "slicePlaneEnabled", void 0), u2 = e([n("esri.views.3d.layers.GraphicsLayerView3D")], u2);
var h = u2;
export {
  h as default
};
//# sourceMappingURL=GraphicsLayerView3D-P4B3GJUP.js.map
