...
function G2(e3) {
  return true === S.spatialRelationship[e3];
}
function g(e3) {
  return true === S.queryGeometry[v(e3)];
}
function j(e3) {
  return true === S.layerGeometry[e3];
}
function h2() {
  return import("./geometryEngineJSON-Y4CNF4IY.js");
}
function v2(e3, n4, l2, y2, c3) {
  if (c(n4) && "esriGeometryPoint" === l2 && ("esriSpatialRelIntersects" === e3 || "esriSpatialRelContains" === e3)) {
    const e4 = D(new t(), n4, false, false);
    return Promise.resolve((r3) => t2(e4, false, false, r3));
  }
  if (c(n4) && "esriGeometryMultipoint" === l2) {
    const r3 = D(new t(), n4, false, false);
    if ("esriSpatialRelContains" === e3)
      return Promise.resolve((e4) => r2(r3, false, false, e4, y2, c3));
  }
  if (s2(n4) && "esriGeometryPoint" === l2 && ("esriSpatialRelIntersects" === e3 || "esriSpatialRelContains" === e3))
    return Promise.resolve((e4) => r(n4, J(l2, y2, c3, e4)));
  if (s2(n4) && "esriGeometryMultipoint" === l2 && "esriSpatialRelContains" === e3)
    return Promise.resolve((e4) => i(n4, J(l2, y2, c3, e4)));
  if (s2(n4) && "esriSpatialRelIntersects" === e3) {
    const e4 = n(l2);
...
function t3(t4, n4) {
  ...
  if (u2 && l2)
    ...
    n4.forEach((n5) => {
      ...
      null == u3 || isNaN(u3) || (r3 = Math.min(r3, u3), i3 = Math.max(i3, u3));
    });
  }
...
function n3(t4, n4, r3) {
  ...
  return null === s3 && null === a ? null : void 0 === s3 && void 0 === a ? l() : i3 && o3 ? e2(r3, i3, o3, s3, a) : u(r3, i3 || o3, s3, a);
}
function e2(t4, n4, e3, u2, l2) {
  return null != u2 && null != l2 ? (r3) => {
    const i3 = t4.getAttribute(r3, n4), o3 = t4.getAttribute(r3, e3);
    return (null == i3 || i3 <= l2) && (null == o3 || o3 >= u2);
  } : null != u2 ? (n5) => {
    const l3 = t4.getAttribute(n5, e3);
    return null == l3 || l3 >= u2;
  } : null != l2 ? (e4) => {
    const u3 = t4.getAttribute(e4, n4);
    return null == u3 || u3 <= l2;
  } : void 0;
}
function u(t4, n4, e3, u2) {
  return null != e3 && null != u2 && e3 === u2 ? (u3) => t4.getAttribute(u3, n4) === e3 : null != e3 && null != u2 ? (l2) => {
    const r3 = t4.getAttribute(l2, n4);
    return r3 >= e3 && r3 <= u2;
  } : null != e3 ? (u3) => t4.getAttribute(u3, n4) >= e3 : null != u2 ? (e4) => t4.getAttribute(e4, n4) <= u2 : void 0;
}
function l() {
  return () => false;
}
...
//# sourceMappingURL=chunk-T6XN76GI.js.map
