...
function n(a, e2) {
  ...
  const n2 = 0, L2 = 0, l3 = e2 ? 0.35 * m2 : 0.5 * m2;
  return [{ type: "path", path: [{ command: "M", values: [0.5 * m2, n2] }, { command: "L", values: [m2, 0.5 * l3] }, { command: "L", values: [0.5 * m2, l3] }, { command: "L", values: [L2, 0.5 * l3] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [n2, 0.5 * l3] }, { command: "L", values: [0.5 * m2, l3] }, { command: "L", values: [0.5 * m2, c2] }, { command: "L", values: [L2, c2 - 0.5 * l3] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [0.5 * m2, l3] }, { command: "L", values: [0.5 * m2, c2] }, { command: "L", values: [m2, c2 - 0.5 * l3] }, { command: "L", values: [m2, 0.5 * l3] }, { command: "Z", values: [] }] }];
}
function L(a, e2) {
  let m2 = e2 ? t.tallSymbolWidth : a;
  const c2 = a, p2 = e2 ? 4 : 6;
  m2 <= t.size ? m2 -= 0.5 * p2 : m2 -= p2;
  const n2 = 0.5 * m2, L2 = 0.15 * m2, l3 = 0, o2 = c2 - L2;
  return [{ type: "ellipse", cx: 0.5 * m2, cy: o2, rx: n2, ry: L2 }, { type: "path", path: [{ command: "M", values: [l3, L2] }, { command: "L", values: [l3, o2] }, { command: "L", values: [m2, o2] }, { command: "L", values: [m2, L2] }, { command: "Z", values: [] }] }, { type: "ellipse", cx: 0.5 * m2, cy: L2, rx: n2, ry: L2 }];
}
function l2(a, e2) {
  let m2 = e2 ? t.tallSymbolWidth : a;
  const c2 = a, p2 = e2 ? 4 : 6;
  m2 <= t.size ? m2 -= 0.5 * p2 : m2 -= p2;
  const n2 = 0.15 * m2, L2 = c2 - n2;
  return [{ type: "ellipse", cx: 0.5 * m2, cy: L2, rx: 0.5 * m2, ry: n2 }, { type: "path", path: [{ command: "M", values: [0.5 * m2, 0] }, { command: "L", values: [m2, L2] }, { command: "L", values: [0, L2] }, { command: "Z", values: [] }] }];
}
function o(a) {
  let e2 = a;
  const m2 = a, c2 = 6;
  e2 < t.size ? e2 -= 0.5 * c2 : e2 -= c2;
  const p2 = 0.15 * e2, n2 = 0;
  return [{ type: "path", path: [{ command: "M", values: [0, n2] }, { command: "L", values: [e2, n2] }, { command: "L", values: [0.5 * e2, m2 - p2] }, { command: "Z", values: [] }] }, { type: "ellipse", cx: 0.5 * e2, cy: n2, rx: 0.5 * e2, ry: p2 }];
}
function s(a) {
  let e2 = a;
  const m2 = a, c2 = 4;
  e2 < t.size ? e2 -= 0.5 * c2 : e2 -= c2;
  const p2 = 0, n2 = 0, L2 = e2, l3 = m2, o2 = Math.floor(a / 10) - 1 || 1;
  return [{ type: "path", path: [{ command: "M", values: [0.45 * L2, p2] }, { command: "L", values: [L2, 0.5 * l3 - o2] }, { command: "L", values: [0.45 * L2 - o2, 0.5 * l3 + o2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [0.45 * L2, p2] }, { command: "L", values: [0.45 * L2 - o2, 0.5 * l3 + o2] }, { command: "L", values: [n2, 0.5 * l3 - o2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [n2, 0.5 * l3 - o2] }, { command: "L", values: [0.45 * L2 - o2, 0.5 * l3 + o2] }, { command: "L", values: [0.45 * L2, m2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [0.45 * L2, m2] }, { command: "L", values: [L2, 0.5 * l3 - o2] }, { command: "L", values: [0.45 * L2 - o2, 0.5 * l3 + o2] }, { command: "Z", values: [] }] }];
}
function u(a) {
  const e2 = a, m2 = 2;
  let c2 = a;
...
//# sourceMappingURL=chunk-I6H66HCE.js.map
